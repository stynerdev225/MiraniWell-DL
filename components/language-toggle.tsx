...
export const LanguageToggle = () => {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {/* Language dropdown - only visible when open */}
            {isOpen && (
                <div className="absolute top-full right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-xl w-72 z-[99999]">
                    <div className="p-4">
                        ...
                        {languageOptions.map((language) => (
                            ...
                            >
                                <span className="text-base min-w-[28px] flex-shrink-0">{language.flag}</span>
