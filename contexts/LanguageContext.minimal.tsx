...
const minimalTranslations: Record<Language, Record<string, string>> = {
    EN: {
        ...
        'header.whyLingo': 'Why Miriani Well',
        ...
        'whyLingo.title': 'Why choose Miriani Well?',
        'whyLingo.subtitle': 'Discover what makes our wellness platform special',
    ...
    ES: {
        ...
        'header.whyLingo': 'Por qué Miriani Well',
    ...
    FR: {
        ...
        'header.whyLingo': 'Pourquoi Miriani Well',
    ...
    DE: {
        ...
        'header.whyLingo': 'Warum Miriani Well',
    ...
    IT: {
        ...
        'header.whyLingo': 'Perché Miriani Well',
    ...
    PT: {
        ...
        'header.whyLingo': 'Por que Miriani Well',
    ...
    RU: {
        ...
        'header.whyLingo': 'Почему Miriani Well',
        'header.pricing': 'Цены',
        'header.about': 'О нас',
    ...
    JA: {
        'header.features': '機能',
        'header.whyLingo': 'なぜMiriani Well',
        'header.pricing': '価格',
    ...
    KO: {
        'header.features': '기능',
        'header.whyLingo': '왜 Miriani Well인가',
        'header.pricing': '가격',
        'header.about': '소개',
        'header.contact': '연락처',
        'header.login': '로그인',
    ...
    ZH: {
        'header.features': '功能',
        'header.whyLingo': '为什么选择Miriani Well',
        'header.pricing': '价格',
        'header.about': '关于',
        'header.contact': '联系',
        'header.login': '登录',
    ...
    AR: {
        ...
        'header.whyLingo': 'لماذا Miriani Well',
    ...
    HI: {
        ...
        'header.whyLingo': 'क्यों Miriani Well',
    ...
    NL: {
        ...
        'header.whyLingo': 'Waarom Miriani Well',
