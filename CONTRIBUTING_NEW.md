...
> You must never report security related issues, vulnerabilities or bugs including sensitive information to the issue tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to our security team.
...
Documentation improvements are always welcome. Whether it's fixing typos, adding examples, or improving clarity, your contributions help make the project more accessible to everyone.
...
We're always looking for dedicated contributors to join our project team. If you're interested in taking on a more active role in the project, please reach out to us!
